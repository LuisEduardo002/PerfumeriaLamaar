      ...
      <Container>
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
          <div className="flex flex-col items-center text-center md:items-start md:text-left">
            ...
            <div className="mt-5 flex gap-4"><a href="#" className={footerLink}>Instagram</a><a href="#" className={footerLink}>Facebook</a><a href="#" className={footerLink}>TikTok</a></div>
          </div>
          ...
          <div><p className="mb-4 text-sm font-semibold uppercase tracking-[0.16em] text-[#C8A450]">Contacto</p><ul className="space-y-3 text-sm"><li>amazingstoresoporte@gmail.com</li><li>+57 304 6420608</li><li>Lun. a sáb., 9:00 a.m. – 6:00 p.m.</li></ul></div>
        </div>
