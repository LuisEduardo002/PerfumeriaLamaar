    ...
    <footer className="mt-auto border-t-4 border-[#C8A450] bg-[#111111] py-12 text-[#CFCFCF]">
      <Container>
        <div className="grid grid-cols-1 gap-10 md:grid-cols-4">
          ...
          <div><h3 className="mb-4 text-sm font-semibold uppercase tracking-[0.16em] text-[#C8A450]">Contacto</h3><ul className="space-y-3 text-sm"><li>info@lammar.com</li><li>+57 300 123 4567</li><li>Lun. a sáb., 9:00 a.m. – 6:00 p.m.</li></ul></div>
        </div>
